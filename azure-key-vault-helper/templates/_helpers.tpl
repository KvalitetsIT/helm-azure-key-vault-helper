...
*/}}
{{- define "azure-key-vault-helper.name" -}}
...
*/}}
{{- define "azure-key-vault-helper.fullname" -}}
...
*/}}
{{- define "azure-key-vault-helper.chart" -}}
...
Common labels
*/}}
{{- define "azure-key-vault-helper.labels" -}}
helm.sh/chart: {{ include "azure-key-vault-helper.chart" . }}
